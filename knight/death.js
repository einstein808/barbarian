...
// Carregar o sprite sheet contendo 6 frames de death
...
let currentFrame = 0;
let lastFrameTime = 0;
const frameDuration = 120; // Velocidade da animação em ms
...
sprite.onload = () => {
    console.log("Sprite death carregado com sucesso!");
    requestAnimationFrame(animate);
};

// Tratamento de erro caso a imagem não carregue
sprite.onerror = () => {
    console.error("Erro ao carregar o sprite: death.png");
};
