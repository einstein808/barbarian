...
// Carregar o sprite sheet contendo 4 frames de hit
...
let currentFrame = 0;
let lastFrameTime = 0;
const frameDuration = 100; // Velocidade da animação em ms
...
sprite.onload = () => {
    console.log("Sprite hit carregado com sucesso!");
    requestAnimationFrame(animate);
};

// Tratamento de erro caso a imagem não carregue
sprite.onerror = () => {
    console.error("Erro ao carregar o sprite: hit.png");
};
