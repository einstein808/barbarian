...
// Carregar o sprite sheet contendo 8 frames de run
...
let currentFrame = 0;
let lastFrameTime = 0;
const frameDuration = 1; // Velocidade da animação em ms (75ms por frame - mais rápido que walk)
...
sprite.onload = () => {
    console.log("Sprite run carregado com sucesso!");
    requestAnimationFrame(animate);
};

// Tratamento de erro caso a imagem não carregue
sprite.onerror = () => {
    console.error("Erro ao carregar o sprite: run.png");
};
